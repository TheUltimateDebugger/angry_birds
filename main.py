...
if __name__ == '__main__':
    ...
    platform = Platform(C.FATAL_RADIUS, C.SAFE_RADIUS, C.ATTACK_DEGREES, ships, C.SYSTEM_BLOCK_PROB)
    ...
    print("cost per missile: " + str(C.DRONES_FOR_MISSILE * (1-C.DRONE_SURVIVAL) * C.DRONE_COST))
